...
function loadData(filename) {
    // Extract the year from the filename, e.g., "age_2021.csv" -> "2021"
    ...
    d3.csv(filename).then(data => {
        ...
        // Filter out any undefined or blank entries in the "Country/area" column
...
// Initial load of the default dataset (2021)
loadData("age_2015.csv");

// Event listener for the dropdown to change dataset
